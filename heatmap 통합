1. DESeq2 진행 후 비교군에서 top gene 뽑는 과정
...
ttt <- data.frame(rank = seq_along(top_genes), top_genes = top_genes)
write_xlsx(ttt, "C:/Users/rkawk/rsem/padj_label_top500(prom1_TdT_TW vs prom1_TdT).xlsx")
--------------------------------------------------------------------------------------------------
